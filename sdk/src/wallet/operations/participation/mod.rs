    ...
    crate::client::Error: From<S::Error>,
{
    ...
    //     let mut participations: HashMap<ParticipationEventId, HashMap<OutputId, TrackedParticipation>> =
    // HashMap::new();
    ...
    //                     log::debug!(
    //                         "[get_participation_overview] skip requesting already known {output_id} for event
    // {event_id}",                     );
    //                     return false;
    //                 }
    //             }
